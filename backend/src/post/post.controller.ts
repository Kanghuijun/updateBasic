...
export class PostController {
  ...
  @Get('search/content')
  async searchByContent(@Query('content') content: string) {
    return {
      message: 'Posts retrieved successfully',
  ...
  @Post()
  async create(@Body() createAnotherpostDto: CreateAnotherpostDto) {
    await this.postService.create(createAnotherpostDto);
  }
  // Read Posts
